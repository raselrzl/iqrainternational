  ...
  return (
    <div className="bg-black">
      <div className="max-w-screen-2xl mx-auto px-2 lg:px-0">
        ...
        <div className="text-center bg-[#2A2A2A] text-white rounded-lg p-10 border-1 border-gray-700 mx-4 mt-16">
          <h2 className="text-2xl font-extrabold uppercase tracking-wide mb-2 blink text-yellow-300">
